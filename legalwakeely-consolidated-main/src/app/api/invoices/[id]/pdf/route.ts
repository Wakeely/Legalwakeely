...
<body>
  ...
  <div class="page">
    ...
    <div class="header">
      <div>
        <div class="brand-name">LEGAL WAKEELY <span>·</span> وكيلة</div>
    ...
    <div class="footer">
      <div class="disclaimer">
        ${isRTL
          ? 'وكيلي القانونى هي أداة توثيق فحسب ولا تقدم استشارات قانونية. هذه الفاتورة صادرة من المحامي مباشرة وليس من وكيلي القانونى.'
          : 'Legal Wakeely is a documentation tool only and does not provide legal advice. This invoice is issued by the lawyer, not by Legal Wakeely.'}
      </div>
      <div class="footer-right">
        ${isRTL ? 'صدرت عبر وكيلي القانونى' : 'Generated via Legal Wakeely'}<br/>
