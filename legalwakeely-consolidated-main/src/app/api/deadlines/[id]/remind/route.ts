...
function buildReminderEmail(
  ...
  const btnText = isAr ? 'فتح وكيلي القانونى' : 'Open Legal Wakeely';
      ...
      <table width="560" cellpadding="0" cellspacing="0"
        ...
        <tr><td style="background:#1A3557;padding:20px 28px">
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td><span style="color:#C89B3C;font-size:22px;font-weight:900;letter-spacing:1px">LEGAL WAKEELY · وكيلي القانونى</span></td>
