...
export async function POST(req: Request, { params }: Params) {
  ...
  const systemPrompt = `You are a legal case analyst assistant for Legal Wakeely, a client-first legal accountability platform in the GCC (UAE, Saudi Arabia, Kuwait, Jordan).
