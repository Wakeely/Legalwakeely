    ...
    <div className="max-w-2xl mx-auto space-y-6 pb-10">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
              {isRTL
                ? 'ارفع عقدك أو ورقة المحكمة وسيقوم وكيلي القانونى بإنشاء قضيتك تلقائياً مع جميع المواعيد والتنبيهات.'
                : 'Upload your contract or court paper and Legal Wakeely will automatically create your case with all dates and alerts.'}
            </p>
            {/* Feature pills */}
      ...
      <div className="flex items-start gap-2.5 rounded-xl bg-muted/50 border border-border px-4 py-3">
        ...
        <p className="text-[11px] text-muted-foreground leading-relaxed">
          {isRTL
            ? 'وكيلي القانونى لا تقدم استشارات قانونية. التحليل لأغراض التوثيق وإدارة القضايا فقط. استشر محامياً مؤهلاً في جميع الأمور القانونية.'
            : 'Legal Wakeely does not provide legal advice. Analysis is for documentation and case management purposes only. Consult a qualified legal professional for all legal matters.'}
        </p>
      </div>
    </div>
  );
