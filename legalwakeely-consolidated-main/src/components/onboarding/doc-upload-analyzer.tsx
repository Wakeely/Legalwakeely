  ...
  if (step === 'upload') return (
    <div className="space-y-5" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <p className="text-center text-[10px] text-muted-foreground/60">
        {isRTL
          ? 'وكيلي القانونى لا تقدم استشارات قانونية. التحليل للأغراض التوثيقية فقط.'
          : 'Legal Wakeely does not provide legal advice. Analysis is for documentation purposes only.'}
      </p>
    </div>
  );
