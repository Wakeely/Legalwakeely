...
export const TIER_GATES = {
  basic: {
    ...
    legal_ai:          false,      // Legal-AI add-on — orthogonal to base tier
  },
  pro: {
    max_cases:         10,
    max_docs:          50,
    ...
    legal_ai:          false,      // still requires the add-on purchase
  },
  premium: {
    max_cases:         Infinity,
    max_docs:          Infinity,
    ...
    voice_tts:         true,
    legal_ai:          true,       // premium bundles the add-on
  },
  ...
  voice_queries_day: number; voice_tts: boolean; legal_ai: boolean;
}>;
