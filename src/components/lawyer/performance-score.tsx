  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-5">
      ...
      <p className="mt-4 text-[10px] text-muted-foreground/50 leading-relaxed">
        {isRTL
          ? 'هذا المؤشر استرشادي بناءً على الإجراءات المسجّلة في وكيلي القانونى. لا يُعدّ حكماً قانونياً.'
          : 'Score is based on logged activity in Legal Wakeely. Not a legal assessment.'}
      </p>
    </div>
  );
}
