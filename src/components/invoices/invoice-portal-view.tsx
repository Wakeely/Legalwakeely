  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-12" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <p className="text-[10px] text-muted-foreground/50 text-center leading-relaxed">
        {isRTL
          ? 'وكيلي القانونى هي أداة توثيق فحسب ولا تقدم استشارات قانونية. هذه الفاتورة صادرة من المحامي مباشرة.'
          : 'Legal Wakeely is a documentation tool only. This invoice is issued by the lawyer, not by Legal Wakeely.'}
      </p>
    </div>
  );
}
