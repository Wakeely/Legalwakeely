...
function Badge({ children }: { children: React.ReactNode }) {
  return (
    <span className="badge-shimmer inline-flex items-center gap-1.5 rounded-full border border-[#085f63]/30 bg-[#085f63]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#085f63]">
      ✦ {children}
    </span>
  );
}
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-5 py-20 text-center">
          ...
          <p className="hero-line mt-7 text-sm text-muted-foreground flex items-center justify-center gap-2" style={{ animationDelay: '540ms' }}>
            <span className="text-[#085f63]">✦</span>
            {c.hero.trust}
          </p>
          ...
          <div className="hero-line mx-auto mt-14 max-w-2xl rounded-2xl border border-border bg-card shadow-2xl overflow-hidden" style={{ animationDelay: '630ms' }}>
            ...
            <div className="p-4 space-y-2">
              {[
                ...
                >
                  <span className={cn('rounded-full px-2.5 py-1 text-xs font-bold shrink-0', row.tag)}>{row.label}</span>
                  <span className="flex-1 text-sm font-medium text-foreground text-start">{row.text}</span>
                  <span className="text-xs text-muted-foreground shrink-0" dir="ltr">{row.date}</span>
                </div>
              ))}
              <div className="mock-row flex items-center gap-3 rounded-xl bg-muted/50 border border-border p-3 mt-1" style={{ animationDelay: '1420ms' }}>
                ...
                <span className="text-base font-black text-[#085f63] tabular-nums shrink-0">72%</span>
              </div>
            </div>
          </div>
        </div>
