    ...
    <div className="rounded-2xl border border-border bg-card overflow-hidden">
      ...
      <div className="px-5 pb-4">
        <p className="text-[9px] text-muted-foreground/50 leading-relaxed">
          {isRTL
            ? 'هذا المؤشر استرشادي بناءً على الإجراءات المسجّلة في وكيلي القانونى. لا يُعدّ حكماً قانونياً أو تقييماً رسمياً.'
            : 'Score is informational, based on logged activity in Legal Wakeely. Not a legal assessment or formal evaluation.'}
        </p>
      </div>
    </div>
  );
