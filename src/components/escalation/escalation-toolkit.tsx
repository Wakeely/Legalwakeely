  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-[10px] text-muted-foreground/60 leading-relaxed text-center">
        {isRTL
          ? 'هذه القوالب استرشادية لأغراض التوثيق فقط. وكيلي القانونى لا تقدم استشارات قانونية. استشر محاميك أو متخصصاً قانونياً قبل إرسال أي رسالة رسمية.'
          : 'These templates are for documentation purposes only. Legal Wakeely does not provide legal advice. Consult a qualified legal professional before sending any formal correspondence.'}
      </p>
    </div>
  );
}
