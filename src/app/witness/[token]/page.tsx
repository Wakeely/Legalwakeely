  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Legal Wakeely Witness View — {caseRow.title}</title>
        ...
        <style>{`
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          body::before {
            content: 'LEGAL WAKEELY WITNESS VIEW — READ ONLY';
      ...
      <body>
        <div className="top-bar">
          <div className="brand">LEGAL WAKEELY <span>·</span> وكيلة</div>
        ...
        <div className="page">
          ...
          <div className="footer">
            <strong style={{color:'#6b7280'}}>Legal Wakeely Witness View</strong> — Read-only access · No legal advice provided<br/>
            This view was shared by the case owner and expires automatically.<br/>
            <a href="https://legalwakeely.com" style={{color:'#1A3557',fontWeight:700}}>legalwakeely.com</a>
          </div>
        </div>
      </body>
    </html>
  ...
  return (
    <html lang="en">
      <head>
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Link Invalid — Legal Wakeely</title>
        <style>{`
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      <body>
        <div className="card">
          ...
          <div className="brand">LEGAL WAKEELY · وكيلة</div>
          ...
          <a href="https://legalwakeely.com">Visit Legal Wakeely</a>
          <p className="disc">Legal Wakeely does not provide legal advice.</p>
        </div>
      </body>
    </html>
  );
