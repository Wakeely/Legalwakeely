...
export async function GET(
  ...
  const rows = timelineEvents.map((ev, i) => {
    ...
    const sysNote = ev.is_system_generated
      ? `<span class="sys-badge">${isRTL ? 'وكيلي القانونى' : 'System'}</span>`
      : '';
  ...
  <div class="page">
    ...
    <div class="header">
      <div class="logo-block">
        <div class="brand">LEGAL WAKEELY <span>·</span> وكيلة</div>
    ...
    <div class="footer">
      <div class="disclaimer">
        ${isRTL
          ? 'وكيلي القانونى هي أداة توثيق فحسب ولا تقدم استشارات قانونية. التنبيهات استرشادية ولا تُعدّ أحكاماً قانونية. استشر دائماً محامياً مرخّصاً في جميع الأمور القانونية.'
          : 'Legal Wakeely is a documentation tool only and does not provide legal advice. Alerts are informational and do not constitute legal findings of negligence. Always consult a licensed legal professional.'}
      </div>
      <div class="page-num">legalwakeely.com · ${isRTL ? 'وكيلي القانونى' : 'Legal Wakeely'}</div>
    </div>
