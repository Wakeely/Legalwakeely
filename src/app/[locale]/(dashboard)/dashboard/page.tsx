  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <p className="text-[10px] text-muted-foreground/50 text-center max-w-lg mx-auto leading-relaxed">
        {isRTL
          ? 'وكيلي القانونى أداة توثيق فقط. التنبيهات استرشادية وليست أحكاماً قانونية.'
          : 'Legal Wakeely is a documentation tool only. Alerts are informational and do not constitute legal findings.'}
      </p>
    </div>
  );
}
