  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-10" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <p className="text-center text-[10px] text-muted-foreground/60">
        {isRTL
          ? 'وكيلي القانونى لا تقدم استشارات قانونية. المستشار الصوتي لأغراض الإرشاد وإدارة القضايا فقط. استشر محامياً مؤهلاً في جميع الأمور القانونية.'
          : 'Legal Wakeely does not provide legal advice. The voice advisor is for case management guidance only. Consult a qualified legal professional for all legal matters.'}
      </p>
    </div>
  );
}
